...
<div class="login-box">
  <div class="login-logo">
    <a href="assets/index2.html"><b>Banghasyim</b>Register</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan Register</p>

    <form action="login_sql/proses_register.php" method="post" enctype="multipart/form-data">
    ...
    <br>
    <a href="Auth.php" class="text-center">Login disini</a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
